...
SearchTree.prototype.render = function (options) {
    ...
    var a = {
      ...
      input: function () {
        ...
        var selectHtml = '<div class="' + TREE_SELECT_CLASS + ' layui-unselect layui-form-select" id="' + TREE_SELECT_ID + '">' +
          ...
          ' <input type="text" id="' + TREE_INPUT_ID + '" placeholder="' + placeholder + '" value="" ' + readonly + ' class="layui-input layui-unselect" style="display:none">' +
   ...
   * @param filter
   */
  SearchTree.prototype.refresh = function (filter) {
   ...
   * @param id 选中的id
   */
  SearchTree.prototype.checkNode = function(filter, id){
   ...
   * @param fn 回调函数
   */
  SearchTree.prototype.revokeNode = function(filter, fn){
    var o = obj.filter(filter);
    o.find('a[treenode_a]').removeClass('curSelectedNode');
   ...
   * 销毁组件
   */
  SearchTree.prototype.destroy = function(filter) {
    var o = obj.filter(filter);
    o.remove();
    obj.get(filter).show();
  }
   ...
   * @param filter
   */
  SearchTree.prototype.zTree = function (filter) {
