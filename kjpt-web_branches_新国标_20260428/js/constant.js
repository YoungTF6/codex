...
var huayi_url = "http://localhost:20004/"; // dev
var test_huayi_url = "https://testkjpt.wsglw.net/kjptapi/";


const huayi_sjwh_url = test_huayi_url + "sjwh/";
const huayi_permission_url = huayi_url + "permission/";
const huayi_personorg_url = huayi_url + "personorg/";
const huayi_mcenter_url = test_huayi_url + "mcenter/";
const huayi_upload_url =  "https://testkjpt.wsglw.net/kjptapi/file/";
// const huayi_upload_url = huayi_url + "file/";
const huayi_projectscore_url = huayi_url + "projectscore/";
const huayi_flow_url = test_huayi_url + "flow/";
const huayi_noticenews_url = test_huayi_url + "notice/";
const huayi_statistics_url = test_huayi_url + "statistics/";
