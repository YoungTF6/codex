...
let _html = {
    ...
    getcpturl: function (conf) {
        let {holdYear, slId, projectId, source, preview, regionLevelId, projType, projectType} = conf;
...
function getcpturl2(holdYear, slId, projectId, source, preview, projType, regionLevelId, projectType) {
