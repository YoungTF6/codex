            ...
            <div class="layui_mess">
                <div class="layui_display">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="float: left;">
                            <input type="text" name="endDate" class="layui-input" id="endDateSelector"  autocomplete="off" placeholder="选择结束日期">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">人员编号</label>
                        <div class="layui-input-block">
                            <input type="number" name="personNo" placeholder="请填写人员编号"  autocomplete="off" class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">人员姓名</label>
                        <div class="layui-input-block">
                            <input type="text" name="personName" placeholder="请填写人员姓名"  autocomplete="off" class="layui-input"/>
                        </div>
                    </div>
                ...
                <div class="layui_display">
                    <div class="layui-inline">
                        <button class="layui-btn layui-btn-sm btnRounded" lay-submit onclick="refreshSingleScoreTable()">
...
layui.config({
    ...
    function createTableToolbar() {
        return `<div><a class="layui-btn layui-btn-sm" lay-event="exportExcel" style="float: right;">导出Excel</a></div>`;
    }
    ...
    function renderSingleScoreTable() {
        table.render({
            ...
            cols: [[
                ...
                {field: 'score', title: '学分', minWidth: 40, align: 'center', sort: true},
                {field: 'period', title: '学时', minWidth: 40, align: 'center', sort: true},
