        ...
        <div id="scoreTotalDiv" class="layui-card-body layui_body_box score_total">
            ...
            <div class="xuefen_box" id="score_total">
                <ul class="xuefen_item" style="margin-bottom: 16px;">
                    ...
                    <li class="col">
                        <h1 data-id="total_period">-</h1><span>学习时长</span></li>
                    <li>
                ...
                <ul class="xuefen_item">
                    ...
                    <li class="col">
                        <h1 data-id="total_period_y">-</h1><span>学习时长</span></li>
                    <li>
...
layui.config({
    ...
    function renderScoreDetailTable() {
        let columns = [
                ...
                {field: 'scoreType', title: '活动内容', minWidth: 120, align: 'center', hide: true, templet: data => _txt.scoreType(data.scoreType)},
                {field: 'score', title: '学分', width: 80, align: 'center'},
                {field: 'period', title: '学习时长', width: 110, align: 'center'},
                {field: 'period', title: '学时', width: 80, align: 'center', templet: function(d){
                    let tempData = $('#cmeYearSelector').find("option:selected").text();
                    let cmeYear = tempData ? tempData.split('|')[0] : new Date().getFullYear();
                    return personCreditStatusCommon.generateStudyTimeLength(d.period,cmeYear);
                }},
                {field: 'passState', title: '有效状态', width: 110, align: 'center'},
                {field: 'noPassOpinion', title: '不计入达标原因', minWidth: 200, align: 'center'},
                {field: 'remark', title: '备注', minWidth: 120, align: 'center', hide: false},
            ];
