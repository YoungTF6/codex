function createBaseHtml() {
    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <!--        搜索框区域-->
            <div id="searchBox" class="layui-form layui-card-header layuiadmin-card-header-auto" style="background-color: #f5f5f5;">
                <div class="layui_mess">
                    <div class="layui_display">
                        ...
                        <div class="layui-inline layui-col-md3">
                            ...
                            <div  id="personStateId" class="layui-input-block custom-ignore" data-name="personStates"></div>
                        </div>
                        <div class="layui-inline layui-col-md3">
            ...
            <div class="layui-card-body layui_body_box">
                    <table class="layui-table" id="searchPersonScoreList" lay-filter="searchPersonScoreList" style="margin: 5px 0px;">
                    </table>
            </div>
        </div>
    </div>
...
layui.use(['table', 'form', 'element', 'laydate', 'tool', 'treeSelect', 'xmSelect'], function () {
    ...
    $(() => {
        ...
        if (window.TextReplaceTool && typeof window.TextReplaceTool.changeYear === 'function') {
            window.TextReplaceTool.changeYear(year);
        }
    ...
    form.on('select(layui-select-year)', function(data){
        if(data.value < '2025'){
            ...
            //
            if (window.TextReplaceTool && typeof window.TextReplaceTool.changeYear === 'function') {
                window.TextReplaceTool.changeYear(data.value);
                if(window.TextReplaceTool.forceReplaceTextInDocument === 'function') {
                    window.TextReplaceTool.forceReplaceTextInDocument(document.getElementById("searchBox"));
                }
            }
        }
