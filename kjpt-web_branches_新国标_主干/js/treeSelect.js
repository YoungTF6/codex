...
(function ($) {
  ...
  TreeSelect.prototype.render = function (options) {
    ...
    var a = {
      ...
      onBeforeClick: function (treeId, treeNode, clickFlag) {
        if (beforeClick) {
            var obj = {
                data: DATA,
                current: treeNode,
