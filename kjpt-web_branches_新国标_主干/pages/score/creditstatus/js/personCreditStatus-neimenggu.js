                    ...
                    <div class="layui_display">
                        <div class="layui-inline layui-col-xs12 layui-col-sm6 layui-col-md3">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" id="studyDateCollection" readonly=""  placeholder="请选择">
                            </div>
                        </div>
...
layui.use(['table', 'form', 'element', 'laydate', 'treeSelect', 'personCreditStatusCommon'], function () {
    ...
    function loadColArry(timestamp) {
        ...
        window.colArray = [
            ...
            { field: 'is_intheseries', title: '在编状态', sort: true, align: 'center',hide: false},
            {
                field: 'medical_type', title: '人员类型', sort: true, width: 120, align: 'center', hide: true,
            ...
            { field: 'sumperiod', title: '学习时长',width: 110, sort: true, align: 'center' },
            { field: 'sumperiod', title: '总学时', sort: true, align: 'center',templet: function(d) { 
                if (d.sumperiod == null) return '';
                var studyDateCollection = $('#studyDateCollection').val() || '';
                var endDate = studyDateCollection.split(' - ')[1] || '';
                var selectedYear = parseInt(endDate.split('-')[0], 10);
                return personCreditStatusCommon.generateStudyTimeLength(d.sumperiod,selectedYear);
            } }
        ];
