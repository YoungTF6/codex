...
layui.use(['table','tool','excel','personCreditStatusCommon'], function () {
    ...
    const _cmeYear = cmeYear ? cmeYear : startDt.substring(0,4);
    ...
    const colsArr = [[
        ...
        {field: 'period', title: '学习时长',align: 'center',width: 110},
        {field: 'period', title: '学时',align: 'center',width: 80,templet:function(d){
            return personCreditStatusCommon.generateStudyTimeLength(d.period,_cmeYear);
        }}
    ]];
