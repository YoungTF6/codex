...
// 全局配置及引入相关的模块
layui.use(['table','tool','excel','personCreditStatusCommon'], function () {
    let table = layui.table,$ = layui.jquery,layer = layui.layer;
    let tool=layui.tool,excel = layui.excel,personCreditStatusCommon=layui.personCreditStatusCommon;
    ...
    const colsArr = [[
            ...
            {field: 'period', title: '学习时长',align: 'center',sort: true,minWidth: 110},
            {field: 'period', title: '学时',align: 'center',sort: true,minWidth: 90,templet:function(d){
                let tempYear = cmeYear ? cmeYear : startDt.substr(0,4);
                return personCreditStatusCommon.generateStudyTimeLength(d.period,tempYear);
            }},
